# Generated by Powerlevel10k configuration wizard on 2024-12-31 at 11:11 JST.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_DEFAULT_VISUAL_IDENTIFIER_EXPANSION='⚠️ '
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local   unstaged='%39F'   # blue foreground
    ...
    typeset -g __VCS_SHORTEN_LEN=256
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      (( $#branch > $__VCS_SHORTEN_LEN )) && branch[13,-13]="…"  # <-- this line
    ...
    if [[ -n $VCS_STATUS_TAG
      ...
      (( $#tag > $__VCS_SHORTEN_LEN )) && tag[13,-13]="…"  # <-- this line
      res+="${meta}#${clean}${tag//\%/%%}"
    fi
    ...
    (( VCS_STATUS_NUM_CONFLICTED )) && res+=" ${conflicted}conflict:${VCS_STATUS_NUM_CONFLICTED}"
  ...
  typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%Y-%m-%d %A %K:%M:%S}'
